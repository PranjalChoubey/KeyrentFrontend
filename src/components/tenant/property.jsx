    ...
    <div className="px-12 " style={{ backgroundColor: '#ffff' }}>
     ...
     End Date
        ...
        <div className="sm:col-span-3">
          ...
          <button className="block text-sm font-medium leading-6 text-gray-900 rounded-md px-4 bg-emerald-600">
            Disable
          </button>
          </div>
          ...
          <button 
                type="submit"
                className="flex flex-row  px-[50px] mt-[545px] justify-center rounded-md bg-emerald-600 text-sm font-semibold leading-6 text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
              >
              Save
              </button>
          </div>
