...
const LoginPage = () => {
  ...
  return (
    <div
      className="w-full relative bg-white h-[1080px] overflow-hidden cursor-pointer text-left text-base text-text1 font-head5-2-23-med"
    ...
    >
      ...
      <img
        className="absolute top-[0px] left-[420px] w-[1300px] h-[893px]"
        alt=""
      />
      <b className="absolute top-[48px] left-[116px] text-45xl tracking-[-0.5px] capitalize text-secondary text-center">
        Login
      </b>
      <div className="absolute top-[68px] left-[961px] w-[343px] h-14">
        <Property1Variant
        ...
        />
        <div className="absolute left-[0px] tracking-[0.15px]">
      ...
      <div className="absolute top-[91.39%] left-[12.92%] tracking-[0.15px] font-semibold text-aliceblue [text-shadow:0px_4px_4px_rgba(0,_0,_0,_0.25)] [-webkit-text-stroke:1px_#fff6f6]">
        support@keyrent.com
      </div>
      <img
        className="absolute top-[917px] left-[917px] w-20 h-20 object-cover"
        alt=""
